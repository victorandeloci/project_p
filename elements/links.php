<?php 
  $links = get_page_by_path('links', OBJECT, 'home');
  if ($links) :
?>

    <div class="links">
        <?php if (!empty(get_post_meta($links->ID, 'rss', true))) : ?>
            <a title="Assinar o Feed" href="<?= get_post_meta($links->ID, 'rss', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta($links->ID, 'spotify', true))) : ?>
            <a title="Ouvir no Spotify" href="<?= get_post_meta($links->ID, 'spotify', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta($links->ID, 'apple', true))) : ?>
            <a title="Ouvir no Apple Podcasts" href="<?= get_post_meta($links->ID, 'apple', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta($links->ID, 'google', true))) : ?>
            <a title="Ouvir no Google Podcasts" href="<?= get_post_meta($links->ID, 'google', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta($links->ID, 'deezer', true))) : ?>
            <a title="Ouvir no Deezer" href="<?= get_post_meta($links->ID, 'deezer', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta($links->ID, 'amazon', true))) : ?>
            <a title="Ouvir no Amazon Music" href="<?= get_post_meta($links->ID, 'amazon', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta($links->ID, 'yt_music', true))) : ?>
            <a title="Ouvir no YouTube Music" href="<?= get_post_meta($links->ID, 'yt_music', true) ?>" target="_blank" rel="noopener noreferrer">
