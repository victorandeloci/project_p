...
?>
    ...
    <div id="playlistPlayerModal" class="aesthetic-windows-95-modal">
        ...
        <div id="playlistPlayer">
            ...
            <audio src="https://github.com/rafaelreis-hotmart/Audio-Sample-files/raw/master/sample.mp3" class="playlist-audio" id="playlistAudio"></audio>
        </div>
    </div>
<?php endif; ?>
