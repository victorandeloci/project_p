        ...
        <div id="playlistPlayerModal" class="aesthetic-windows-95-modal">
            ...
            <div class="playlist-player-details">
                        ...
                        <?php 
                            if ($query->have_posts()) :
                                foreach ($query->posts as $i => $post) :
                                    ...
                                    if (!empty($mp3Url)) :
                                        // save total duration when media s available
                ...
                <div class="row total-details">
                    <div class="column aesthetic-windows-95-container excerpt-container">
                        Total Duration: <span id="ppTotalPlay"><?= $totalDuration ?></span>
                    </div>
                    <div class="column aesthetic-windows-95-container excerpt-container">
                        Track: <span id="ppTrackDuration">0:00</span>
                    </div>
                </div>
            </div>
